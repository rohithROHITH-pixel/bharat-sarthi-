...
export const newsItems: NewsArticle[] = [
  ...
  },
  {
    ...
    summary: 'ವಿಶ್ವವಿಖ್ಯಾತ ಮೈಸೂರು ದಸರಾ ಮಹೋತ್ಸವಕ್ಕೆ ಸಿದ್ಧತೆಗಳು ಆರಂಭವಾಗಿದ್ದು, ಕ್ಯಾಪ್ಟನ್ ಅಭಿಮನ್ಯು ನೇತೃತ್ವದ ಗಜಪಡೆಯ ಮೊದಲ ತಂಡ ಅರಮನೆ ನಗರಿಗೆ ಸಾंಪ್ರದಾಯಿಕ ಸ್ವಾಗತದೊಂದಿಗೆ ಆಗಮಿಸಿದೆ.',
    time: '2 ದಿನಗಳ ಹಿಂದೆ',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    summary: 'ಮುಂದಿನ ಐಪಿಎల్ ಆವೃತ್ತಿಗಾಗಿ ರಾಯಲ್ ಚಾಲೆಂಜರ್ಸ್ ಬೆಂಗಳೂರು ತಂಡವು ಆಸ್ಟ್ರೇಲಿಯಾದ ಮಾಜಿ ಆಟಗಾರ ಆಂಡಿ ಫ್లవర్ ಅವರನ್ನು ಮುಖ್ಯ ಕೋಚ್ ಆಗಿ ನೇಮಿಸಿದೆ.',
    time: '5 ದಿನಗಳ ಹಿಂದೆ'
  },
  {
    id: 9,
